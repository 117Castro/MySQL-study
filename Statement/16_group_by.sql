SELECT MAX(age) AS 'minima edad' FROM users GROUP BY surname;

SELECT MIN(age) AS 'minima edad' FROM users GROUP BY surname;

SELECT MAX(age) AS 'minima edad' FROM users GROUP BY age;

SELECT MAX(age) AS 'minima edad', age FROM users WHERE age > 30 AND age < 50 GROUP BY age ORDER BY MAX(age) ASC ;
...
SELECT MAX(age) AS 'minima edad', age FROM users GROUP BY age ;
